...
def inference(global_config, checkpoint_dir, input_paths, K=None, local_regions=True, skip_border_objects=False, filter_grasps=True, segmap_id=None, z_range=[0.2,1.8], forward_passes=1):
    ...
    train_saver = tf.train.Saver(save_relative_paths=True)
    saver = train_saver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ckpt_dir', default='checkpoints/scene_2048_bs3_rad2_32', help='Log dir [default: checkpoints/scene_test_2048_bs3_hor_sigma_001]')
